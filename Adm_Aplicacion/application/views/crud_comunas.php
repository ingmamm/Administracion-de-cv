  ...
  <div class="container_12">
        ...
        <div class="grid_12">
            <div class="grid_12" id="head">
                ...
                <div class="grid_2" id="head_email">Nombre</div>
                <div class="grid_2" id="head_registro">Provincia</div>
                ...
                ?>
                        <div class="grid_12" id="body">
                            ...
                            <div class="grid_2" id="nombre<?=$dato->pk?>"><?=$dato->comuna?></div>
                            <div class="grid_2" id="alfa_dos<?=$dato->pk?>"><?=$dato->provincia?></div>
